...
"""不确定性建模Panel类"""
class UncertaintyModelingPanel(wx.Panel):
    ...
    def InitUI(self):
        ...
        """添加菜单按钮"""
        self.button1 = wx.Button(self.m_panel5, wx.ID_ANY, u"数据预处理", wx.DefaultPosition,
                                 wx.DefaultSize, 0)
        ...
        self.button2 = wx.Button(self.m_panel5, wx.ID_ANY, u"不确定性定义", wx.DefaultPosition,
                                 wx.DefaultSize, 0)
        tabSizer.Add(self.button2, 0, wx.ALL, 5)

        self.button3 = wx.Button(self.m_panel5, wx.ID_ANY, u"不确定性描述", wx.DefaultPosition,
                                 wx.DefaultSize, 0)
        ...
        self.navPanel = UMNavPanel.NavPanel(self.m_panel6)
        bSizer4.Add(self.navPanel, 1, wx.EXPAND | wx.ALL, 5)

        self.showPanel = UMShowPanel.ShowPanel(self.m_panel6)
